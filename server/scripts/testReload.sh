...
Relance_App()
{
    ...
    do
        ...
        then
                ...
                let NUM_ERR++ 
                USER=
                CMD_WIN="powershell ./database.ps1 start $instance Oracle $SRV" 
                echo
    ...
    do
        ...
        then
                ...
                let NUM_ERR++ 
                USER=
                CMD_WIN="powershell ./database.ps1 status $instance Oracle $SRV" 
                echo
                echo "DEBUT : $(date +'%d/%m/%Y %H:%M:%S')"
                echo "Serveur "$SRV" - ["$TYPE_ACTION":"$APPLI":"$ETAPE"/"$NB_ETAPE"]" 
                echo "Commande : "$CMD_WIN
...
Arret_App()
{
    ...
    do
        ...
        then
                ...
                let NUM_ERR++ 
                USER=
                CMD_WIN="powershell ./database.ps1 stop $instance Oracle $SRV" 
                echo
                echo "DEBUT : $(date +'%d/%m/%Y %H:%M:%S')"
                echo "Serveur "$SRV" - ["$TYPE_ACTION":"$APPLI":"$ETAPE"/"$NB_ETAPE"]" 
                echo "Commande : "$CMD_WIN
