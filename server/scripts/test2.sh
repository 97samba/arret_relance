...
Relance_App()
{
    ...
    do
        ...
        then
                ...
                SRV=$sw11022
                USER=
                CMD_WIN="powershell ./service.ps1 start wuauserv $SRV" 
                echo
    ...
    do
        ...
        then
                ...
                SRV=$sw11203
                USER=
                CMD_WIN="powershell ./service.ps1 status wuauserv $SRV" 
                echo
                echo "DEBUT : $(date +'%d/%m/%Y %H:%M:%S')"
                echo "Serveur "$SRV" - ["$TYPE_ACTION":"$APPLI":"$ETAPE"/"$NB_ETAPE"]" 
                echo "Commande : "$CMD_WIN
...
Arret_App()
{
    ...
    do
        ...
        then
                ...
                SRV=$localhost
                USER=
                CMD_WIN="powershell ./service.ps1 stop bits $SRV" 
                echo
                echo "DEBUT : $(date +'%d/%m/%Y %H:%M:%S')"
                echo "Serveur "$SRV" - ["$TYPE_ACTION":"$APPLI":"$ETAPE"/"$NB_ETAPE"]" 
                echo "Commande : "$CMD_WIN
    ...
    do
        ...
        then
                ...
                SRV=$sw11203
                USER=
                CMD_WIN="powershell ./service.ps1 stop wuauserv $SRV" 
                echo
                echo "DEBUT : $(date +'%d/%m/%Y %H:%M:%S')"
                echo "Serveur "$SRV" - ["$TYPE_ACTION":"$APPLI":"$ETAPE"/"$NB_ETAPE"]" 
                echo "Commande : "$CMD_WIN
...
Tests_App()
{
    ...
    SRV="sw11203"
    USER=
    CMD="service status wuauserv  sw11203" 
    CMD_WIN="powershell ./service.ps1 status wuauserv  sw11203" 
    SSA : "$APPLI"
    Serveur : "$SRV"
    Commande : "$CMD_WIN"
    res=$(ssh -o BatchMode=yes -o ConnectTimeout=5 -o StrictHostKeyChecking=no -q adm-deploy@$REBOND_WIN "$CMD_WIN")
    ...
    SRV="sw11022"
    USER=
    CMD="service status wuauserv  sw11022" 
    CMD_WIN="powershell ./service.ps1 status wuauserv  sw11022" 
    SSA : "$APPLI"
    Serveur : "$SRV"
    Commande : "$CMD_WIN"
    res=$(ssh -o BatchMode=yes -o ConnectTimeout=5 -o StrictHostKeyChecking=no -q adm-deploy@$REBOND_WIN "$CMD_WIN")
