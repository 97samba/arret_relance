...
Relance_App()
{
		...
		then
				...
				SRV=sw11183
				USER=
				CMD_WIN="powershell ./rename.ps1 c:\temp\test.txt.old test sw11183" 
				echo
		...
		then
				...
				SRV=sw11183
				USER=
				CMD_WIN="powershell ./checkDisk.ps1 C D E sw11183" 
				echo
				echo "DEBUT : $(date +'%d/%m/%Y %H:%M:%S')"
				echo "Serveur "$SRV" - ["$TYPE_ACTION":"$APPLI":"$ETAPE"/"$NB_ETAPE"]" 
				echo "Commande : "$CMD_WIN
		...
		then
				...
				SRV=sw11183
				USER=
				CMD_WIN="powershell ./checkLog.ps1 execution c:\temp\logger.txt sw11183" 
				echo
				echo "DEBUT : $(date +'%d/%m/%Y %H:%M:%S')"
				echo "Serveur "$SRV" - ["$TYPE_ACTION":"$APPLI":"$ETAPE"/"$NB_ETAPE"]" 
				echo "Commande : "$CMD_WIN
		...
		then
				...
				SRV=sw11193
				USER=
				CMD_WIN="powershell ./database.ps1 start H00131E0 MSSQL sw11193" 
				echo
				echo "DEBUT : $(date +'%d/%m/%Y %H:%M:%S')"
				echo "Serveur "$SRV" - ["$TYPE_ACTION":"$APPLI":"$ETAPE"/"$NB_ETAPE"]" 
				echo "Commande : "$CMD_WIN
		...
		then
				...
				SRV=sw11193
				USER=
				CMD_WIN="powershell ./database.ps1 start H00121E0 MSSQL sw11193" 
				echo
				echo "DEBUT : $(date +'%d/%m/%Y %H:%M:%S')"
				echo "Serveur "$SRV" - ["$TYPE_ACTION":"$APPLI":"$ETAPE"/"$NB_ETAPE"]" 
				echo "Commande : "$CMD_WIN
		...
		then
				...
				SRV=sw11193
				USER=
				CMD_WIN="powershell ./database.ps1 start H00120E0 MSSQL sw11193" 
				echo
				echo "DEBUT : $(date +'%d/%m/%Y %H:%M:%S')"
				echo "Serveur "$SRV" - ["$TYPE_ACTION":"$APPLI":"$ETAPE"/"$NB_ETAPE"]" 
				echo "Commande : "$CMD_WIN
		...
		then
				...
				SRV=sw11203
				USER=
				CMD_WIN="powershell ./invoke.ps1 c:\temp\scripts\test-start.bat sw11203" 
				echo
				echo "DEBUT : $(date +'%d/%m/%Y %H:%M:%S')"
				echo "Serveur "$SRV" - ["$TYPE_ACTION":"$APPLI":"$ETAPE"/"$NB_ETAPE"]" 
				echo "Commande : "$CMD_WIN
		...
		then
				...
				SRV=sw11203
				USER=
				CMD_WIN="powershell ./process.ps1 start java.exe sw11203" 
				echo
				echo "DEBUT : $(date +'%d/%m/%Y %H:%M:%S')"
				echo "Serveur "$SRV" - ["$TYPE_ACTION":"$APPLI":"$ETAPE"/"$NB_ETAPE"]" 
				echo "Commande : "$CMD_WIN
		...
		then
				...
				SRV=sw11203
				USER=
				CMD_WIN="powershell ./service.ps1 start bits sw11203" 
				echo
				echo "DEBUT : $(date +'%d/%m/%Y %H:%M:%S')"
				echo "Serveur "$SRV" - ["$TYPE_ACTION":"$APPLI":"$ETAPE"/"$NB_ETAPE"]" 
				echo "Commande : "$CMD_WIN
		...
		then
				...
				SRV=sw11203
				USER=
				CMD_WIN="powershell ./service.ps1 status bits sw11203" 
				echo
				echo "DEBUT : $(date +'%d/%m/%Y %H:%M:%S')"
				echo "Serveur "$SRV" - ["$TYPE_ACTION":"$APPLI":"$ETAPE"/"$NB_ETAPE"]" 
				echo "Commande : "$CMD_WIN
...
Arret_App()
{
		...
		then
				...
				SRV=sw11203
				USER=
				CMD_WIN="powershell ./process.ps1 status java.exe sw11203" 
				echo
				echo "DEBUT : $(date +'%d/%m/%Y %H:%M:%S')"
				echo "Serveur "$SRV" - ["$TYPE_ACTION":"$APPLI":"$ETAPE"/"$NB_ETAPE"]" 
				echo "Commande : "$CMD_WIN
		...
		then
				...
				SRV=sw11203
				USER=
				CMD_WIN="powershell ./invoke.ps1 c:\temp\scripts\test-stop.bat sw11203" 
				echo
				echo "DEBUT : $(date +'%d/%m/%Y %H:%M:%S')"
				echo "Serveur "$SRV" - ["$TYPE_ACTION":"$APPLI":"$ETAPE"/"$NB_ETAPE"]" 
				echo "Commande : "$CMD_WIN
		...
		then
				...
				SRV=sw11193
				USER=
				CMD_WIN="powershell ./database.ps1 status H00120E0 MSSQL sw11193" 
				echo
				echo "DEBUT : $(date +'%d/%m/%Y %H:%M:%S')"
				echo "Serveur "$SRV" - ["$TYPE_ACTION":"$APPLI":"$ETAPE"/"$NB_ETAPE"]" 
				echo "Commande : "$CMD_WIN
		...
		then
				...
				SRV=sw11193
				USER=
				CMD_WIN="powershell ./database.ps1 status H00121E0 MSSQL sw11193" 
				echo
				echo "DEBUT : $(date +'%d/%m/%Y %H:%M:%S')"
				echo "Serveur "$SRV" - ["$TYPE_ACTION":"$APPLI":"$ETAPE"/"$NB_ETAPE"]" 
				echo "Commande : "$CMD_WIN
		...
		then
				...
				SRV=sw11193
				USER=
				CMD_WIN="powershell ./database.ps1 status H00131E0 MSSQL sw11193" 
				echo
				echo "DEBUT : $(date +'%d/%m/%Y %H:%M:%S')"
				echo "Serveur "$SRV" - ["$TYPE_ACTION":"$APPLI":"$ETAPE"/"$NB_ETAPE"]" 
				echo "Commande : "$CMD_WIN
		...
		then
				...
				SRV=sw11183
				USER=
				CMD_WIN="powershell ./rename.ps1 c:\temp\test.txt test.old sw11183" 
				echo
				echo "DEBUT : $(date +'%d/%m/%Y %H:%M:%S')"
				echo "Serveur "$SRV" - ["$TYPE_ACTION":"$APPLI":"$ETAPE"/"$NB_ETAPE"]" 
				echo "Commande : "$CMD_WIN
...
Tests_App()
{
		...
		SRV="sw11203"
		USER=
		CMD="service status bits  sw11203" 
		CMD_WIN="powershell ./service.ps1 status bits  sw11203" 
		SSA : "$APPLI"
		Serveur : "$SRV"
		Commande : "$CMD_WIN"
		...
		SRV="sw11203"
		USER=
		CMD="process status java.exe  sw11203" 
		CMD_WIN="powershell ./process.ps1 status java.exe  sw11203" 
		SSA : "$APPLI"
		Serveur : "$SRV"
		Commande : "$CMD_WIN"
		...
		SRV="sw11193"
		USER=
		CMD="database status H00120E0 MSSQL sw11193" 
		CMD_WIN="powershell ./database.ps1 status H00120E0 MSSQL sw11193" 
		SSA : "$APPLI"
		Serveur : "$SRV"
		Commande : "$CMD_WIN"
		...
		SRV="sw11193"
		USER=
		CMD="database status H00121E0 MSSQL sw11193" 
		CMD_WIN="powershell ./database.ps1 status H00121E0 MSSQL sw11193" 
		SSA : "$APPLI"
		Serveur : "$SRV"
		Commande : "$CMD_WIN"
		...
		SRV="sw11193"
		USER=
		CMD="database status H00131E0 MSSQL sw11193" 
		CMD_WIN="powershell ./database.ps1 status H00131E0 MSSQL sw11193" 
		SSA : "$APPLI"
		Serveur : "$SRV"
		Commande : "$CMD_WIN"
